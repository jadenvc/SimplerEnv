...
"""
usage
python evaluation.py --split train --subset-size 50
python evaluation.py --split val --subset-size 50
"""
...
def main(args):
    ...
    # Load the dataset
    ds_val = tfds.load('bridge_dataset', data_dir="/iliad/group/datasets/OXE_OCTO", split=args.split)
    ...
    results_dir = f"{args.split}_{args.subset_size}_eval_results"
...
def parse_arguments():
    ...
    parser.add_argument("--split", required=True, help="The split to evaluate on which can be either 'train' or 'val'")
    parser.add_argument("--subset-size", type=int, default=50, help="The number of episodes/subset to evaluate")
